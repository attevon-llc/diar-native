...
#: Corrupt the split tail. It participates in stage 3b (against the fused graph) and 3c
#: (against the multimask tail), so a single edit is visible to two independent checks.
TARGET = "wespeaker-voxceleb-resnet34-tail.onnx"
